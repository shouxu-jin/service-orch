  ...
  <div v-if="easyFlowVisible" style="height: calc(100vh);">
    ...
    <div style="display: flex;height: calc(100% - 47px);">
      ...
      <div style="width: 300px;border-left: 1px solid #dce3e8;background-color: #FBFBFB">
        <flow-node-form ref="nodeForm" @setLineCondition="setLineCondition"
                        @repaintEverything="repaintEverything" @setBoardName="setBoardName"></flow-node-form>
      </div>
    </div>
    <!-- 流程数据详情 -->
    ...
    export default {
        ...
        methods: {
            ...
            loadEasyFlow () {
                ...
                for (var i = 0; i < this.data.lineList.length; i++) {
                    ...
                    var connParam = {
                        source: line.from,
                        target: line.to,
                        label: line.condition ? line.condition : '',
            ...
            setBoardName (board) {
                ...
                this.data.serviceId = board.serviceId
            },
            // 删除激活的元素
            deleteElement () {
